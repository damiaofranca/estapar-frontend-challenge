      ...
      <header className="flex flex-col gap-6">
        <div className="flex flex-col items-start justify-between gap-1">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-semibold tracking-tight text-estapar-medium-gray">Garagens</h1>
          </div>
          <p className="text-sm text-estapar-dark-gray">Visualize as garagens habilitadas para mensalistas digitais.</p>
        </div>
        <GaragesFilters
