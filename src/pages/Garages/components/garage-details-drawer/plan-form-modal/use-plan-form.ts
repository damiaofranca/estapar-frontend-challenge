...
export const buildPlanFormDefaults = (plan?: Plan | null): PlanFormValues => {
  ...
  return {
    ...
    cancellationPrice: Mask.formatCentsToMoneyMask(
      plan.amountDailyCancellationInCents,
    ),
  };
};

const planActiveToApiString = (active: boolean): string =>
	active ? "S" : "N";
...
export const buildUpdatePlanPayload = (
	values: PlanFormValues,
	plan: Plan,
): UpdatePlanPayload => ({
