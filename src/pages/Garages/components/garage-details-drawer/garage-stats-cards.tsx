...
export const GarageStatsCards = ({
  ...
  <div className={cn("w-full grid grid-cols-1 gap-3 sm:grid-cols-3", className)}>
    <StatCard label="Total de Vagas" value={totalSpaces} icon={<UsersIcon className="h-5 w-5 text-estapar-icon" />} />
    <StatCard label="Ocupadas" value={occupiedSpaces} icon={<UsersIcon className="h-5 w-5 text-estapar-warning" />} />
    <StatCard
      label="Disponíveis"
