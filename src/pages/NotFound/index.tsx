...
const NotFoundPage = (): ReactElement => (
  <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-estapar-canvas px-4 py-10 text-center">
    <div className="flex flex-col gap-2">
      <Typography as="p" className="text-sm font-semibold uppercase tracking-wide text-estapar-primary">
        Erro 404
      </Typography>
      <Typography as="h1" className="text-3xl font-bold text-estapar-medium-gray">
        Página não encontrada
      </Typography>
      <Typography as="p" className="max-w-md text-sm text-estapar-dark-gray">
