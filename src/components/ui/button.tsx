...
const buttonVariantClassName: Record<ButtonVariant, string> = {
  ...
  ghost: "text-estapar-body hover:bg-estapar-muted-surface focus-visible:ring-offset-estapar-canvas",
}
...
const ButtonSpinner = ({ size }: ButtonSpinnerProps) => (
  <span className={cn(buttonIconSlotClassName[size], "animate-spin motion-reduce:animate-none")} aria-hidden>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="size-[1em] shrink-0" aria-hidden>
