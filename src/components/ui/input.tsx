import { forwardRef, useId, type ChangeEvent, type ComponentPropsWithoutRef, type ReactNode } from "react"
...
const iconSlotClassName = "pointer-events-none absolute top-1/2 z-10 -translate-y-1/2 text-estapar-subtle [&_svg]:block"
...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const reactId = useId()
    const inputId = idProp ?? (isComposedInput({ label, error, hint, icon, sideIcon }) ? reactId : undefined)
